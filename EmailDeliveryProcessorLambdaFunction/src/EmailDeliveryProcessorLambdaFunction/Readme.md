...
Execute unit tests
```
    cd "EmailDeliveryProcessorLambdaFunction/test/EmailDeliveryProcessorLambdaFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "EmailDeliveryProcessorLambdaFunction/src/EmailDeliveryProcessorLambdaFunction"
